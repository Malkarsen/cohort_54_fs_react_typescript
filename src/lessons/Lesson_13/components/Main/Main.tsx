...
function Main() {
  ...
  return (
    // Шаг 3: Обернуть все, что у нас в return с помощью MainContext.Provider и передать все, что мы хотим, в пропсу value
    <MainContext.Provider
      value={{ userData, setUserData }}
    >
      <MainWrapper>
        <MainTitle>Main Component</MainTitle>
        <Button buttonName="Get User Data" onClick={getUserData} />
        <Section />
      </MainWrapper>
    </MainContext.Provider>
  );
